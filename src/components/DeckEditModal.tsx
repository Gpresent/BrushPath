...
import IndexedDBCaching, { IndexedDBCachingResult } from "../utils/useIndexedDBCaching";
...
const DeckEditModal: React.FC<DeckEditModalProps> = ({ isOpen, onClose, kanjiList,characterCache ,deckName }) => {
